# Building Enterprise-Scale Azure Infrastructure: Lessons from Managing 1,200+ Files of Infrastructure as Code
...
I'm excited to bring this experience to a team that values:
...
**About the Author:** DevOps/Platform Engineer specializing in Azure cloud infrastructure, Infrastructure as Code (Bicep/Terraform), and building reliable, cost-effective platforms that scale. Always learning, always automating.

**Connect with me:** [LinkedIn] | [GitHub] | [Email]

**Repository:** This infrastructure is managed at [GitHub/Azure-IaC] (link if public, or "Available upon request" if private)
